# Source: https://docs.zama.org/protocol/solidity-guides/getting-started/quick-start-tutorial/turn_it_into_fhevm
...
Starting with the plain `Counter.sol` contract that you built from the ["Write a simple contract" tutorial](/protocol/solidity-guides/getting-started/quick-start-tutorial/write_a_simple_contract), and step-by-step, you’ll learn how to:
...
In the [next tutorial](https://github.com/zama-ai/fhevm/blob/release/0.9.x/docs/solidity-guides/getting-started/quick-start-tutorial/test_fhevm_contract.md), we’ll move on to the **TypeScript integration**, where you’ll learn how to interact with your newly upgraded FHEVM contract in a test suite.

[Previous2. Write a simple contract](/protocol/solidity-guides/getting-started/quick-start-tutorial/write_a_simple_contract)[Next4. Test the FHEVM contract](/protocol/solidity-guides/getting-started/quick-start-tutorial/test_the_fhevm_contract)
