...
[Previous4. Test the FHEVM contract](/protocol/solidity-guides/getting-started/quick-start-tutorial/test_the_fhevm_contract)[NextContract addresses](/protocol/solidity-guides/smart-contract/configure/contract_addresses)
