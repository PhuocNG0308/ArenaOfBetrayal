...
[PreviousContract addresses](/protocol/solidity-guides/smart-contract/configure/contract_addresses)[NextOperations on encrypted types](/protocol/solidity-guides/smart-contract/operations)
