# Source: https://docs.zama.org/protocol/solidity-guides/smart-contract/acl/acl_examples

Copy

# ACL examples

This page provides detailed instructions and examples on how to use and implement the ACL (Access Control List) in FHEVM. For an overview of ACL concepts and their importance, refer to the [access control list (ACL) overview](/protocol/solidity-guides/smart-contract/acl).
...
By understanding how to grant and verify permissions, you can effectively manage access to encrypted data in your FHEVM smart contracts. For additional context, see the [ACL overview](/protocol/solidity-guides/smart-contract/acl).

[PreviousAccess Control List](/protocol/solidity-guides/smart-contract/acl)[NextReorgs handling](/protocol/solidity-guides/smart-contract/acl/reorgs_handling)
