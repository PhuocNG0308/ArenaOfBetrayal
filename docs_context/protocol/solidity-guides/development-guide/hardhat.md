...
[PreviousDecryption](/protocol/solidity-guides/smart-contract/oracle)[NextWrite FHEVM tests in Hardhat](/protocol/solidity-guides/development-guide/hardhat/write_test)
