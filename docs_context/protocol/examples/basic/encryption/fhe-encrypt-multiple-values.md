# Source: https://docs.zama.org/protocol/examples/basic/encryption/fhe-encrypt-multiple-values
...
[PreviousEncrypt single value](/protocol/examples/basic/encryption/fhe-encrypt-single-value)[NextDecryption](/protocol/examples/basic/decryption)
