...
[PreviousUser decrypt multiple values](/protocol/examples/basic/decryption/fhe-user-decrypt-multiple-values)[NextPublic Decrypt multiple values](/protocol/examples/basic/decryption/highest-die-roll)
