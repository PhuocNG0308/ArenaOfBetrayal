...
[PreviousPublic Decrypt single value](/protocol/examples/basic/decryption/heads-or-tails)[NextLibrary installation and overview](/protocol/examples/openzeppelin-confidential-contracts/openzeppelin)
