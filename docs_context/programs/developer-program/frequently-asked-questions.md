# Source: https://docs.zama.org/programs/developer-program/frequently-asked-questions
...
### December track update:

Available tracks

* **Builder track:** Build a complete dApp demo using FHEVM. See detailed criteria in the [documentation](https://docs.zama.ai/programs/developer-program).
* **Bounty Track:** The December bounty is to **Build The FHEVM Example Hub**. [See the blog post for details](https://www.zama.org/post/bounty-track-december-2025-build-the-fhevm-example-hub).

Submission portals

* [December Builder Track - Submission Form](https://forms.zama.org/developer-program-builder-november)
* [December Bounty Track - Submission Form](https://forms.zama.org/developer-program-bounty-november)

Submission deadline: **December 26th 2025, 23:59 AOE**
...
Please avoid including **“Zama”** in your project name. Be creative!
This helps prevent confusion and keeps the community safe from potential scam attempts.
...
Explore previous winners' projects: [https://www.zama./programs/developer-program](https://zama-project.webflow.io/programs/developer-program)
...
1. Join via [Guild.xyz](http://guild.xyz) and connect your wallet & GitHub
...
* Follow the specific requirements listed in the bounty announcements on [zama./programs/developer-program](https://zama.ai/programs/developer-program)

### Video instructions

* **Length:** Maximum 2 minutes
* **Requirement:** Real-person pitch only. AI-generated video or voice will not be considered.
* **Submission link:** Upload your video on YouTube or Loom.
...
No, you can submit only one project per month.
...
[PreviousFrequently Asked Questions](/programs/creator-program/frequently-asked-questions)
